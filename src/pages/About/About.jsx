    ...
    <div className="page about">
      ...
      <section className="about-me-copy">
        <div className="about-me-copy-wrapper">
          <h3>
            Lumlens was founded in 2020 as a bold vision to redefine the art of
            video production. Established by a passionate team of creative
            professionals.
          </h3>

          <h3>
            At Lumlens , we believe that video is more than just content—it's a
            canvas for creativity and a tool for impact. Our goal is to craft
            visuals that not only tell compelling stories but also evoke
            emotions and drive action.
          </h3>

          <h3>
            At Lumlens, we’re committed to shaping the future of video with
            innovation and heart, proving that when you combine creativity with
            purpose, you create something truly extraordinary.
          </h3>
        </div>
      </section>
      ...
      <section className="services">
        ...
        <div className="services-col">
          <h4>
            ...
            Whether it’s film, brand, or visual content — let’s create something
            truly unforgettable.
          </h4>
          ...
          <div className="services-list">
            <div className="service-list-row">
              ...
              <div className="service-list-col">
                <p>
                  From concept to final cut, I create cinematic films that spark
                  emotion and leave a lasting impact. Whether it's a short
                  narrative, a documentary, or branded content, I approach each
                  frame with purpose and precision. I believe in storytelling
                  that not only entertains but also connects with audiences on a
                  deeper level.
                </p>
              </div>
            </div>
            ...
            <div className="service-list-row">
              ...
              <div className="service-list-col">
                <p>
                  ...
                  craft visuals that communicate values, spark recognition, and
                  build trust. Every detail is intentional — designed to stand
                  out and scale across every platform.
                </p>
              </div>
            </div>
            ...
            <div className="service-list-row">
              ...
              <div className="service-list-col">
                <p>
                  I lead the creative vision of each project to ensure a unified
                  aesthetic and emotional tone. From pre-production planning to
                  final execution, I oversee the alignment of visuals, story,
                  and strategy. My goal is to bring clarity, originality, and
                  meaning to every piece of content we produce.
                </p>
              </div>
            </div>
          </div>
